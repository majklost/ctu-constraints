...
# def write_bad_indices(folder: Path, check_wall_integrity: bool = True) -> list[int]:
...
#     if mask.ndim != 4:
#         raise ValueError(
#             f"Expected [B, C, H, W] or [C, H, W] mask, got {tuple(mask.shape)}"
#         )
...
#     raise ValueError(
#         f"Expected [C, H, W] or [B, C, H, W] mask, got {tuple(mask.shape)}"
#     )
