...
class VxmPairwise(nn.Module):
    ...
    def __init__(
        ...
        activations: (
            Sequence[Callable[..., Any] | str] | Callable[..., Any] | str | None
        ) = nn.ReLU,
    ...
    def forward(
        ...
        """
        mode = {"velocity", "svf", "displacement"}
        valid_field_types = mode
