...
JOB_INFO=$(ssh -q -T "${REMOTE}" "source /etc/profile && ml PyTorch-Lightning/2.5.5-foss-2025a-CUDA-12.8.0 && ml PyTorch3D/0.7.9-foss-2025a-CUDA-12.8.0 && cd ${PROJECT_DIR} && sbatch --export=ALL start_jupyter.sh")
