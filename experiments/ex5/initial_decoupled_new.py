...
def handle_unet(
    ...
    overlay_computer = SegmentationOverlayComputer(ls, overlay_policy)
...
def handle_decoupled(
    ...
    assert preset in LossPresetName, "preset not known"
    preset = cast(LossPresetName, preset)
